-- LedgerWorks V015: recreate posting guard trigger and functions

DROP TRIGGER IF EXISTS t_entry_block_direct_post ON journal_entry;
DROP FUNCTION IF EXISTS trg_block_direct_post();

CREATE FUNCTION trg_block_direct_post()
RETURNS trigger AS $$
DECLARE
  posting_entry text;
BEGIN
